...
<img src="<?php echo base_url();?>assets/img/small-logo.png" alt="">
</a>
...
<?php
	if($this->uri->segment(2) != 'view_sale')
	{
		?>
...
<img src="<?php echo base_url();?>assets/img/flags/us1.png" alt="" height="20">
</a>
...
<img src="<?php echo base_url();?>assets/img/icons/notification-bing.svg" alt="img"> <span class="badge rounded-pill">4</span>
</a>
...
<?php
	$users = $this->db->query('SELECT * FROM `users` WHERE id = '.$this->session->userdata('user_id'))->row_array();
?>
<li class="nav-item dropdown has-arrow main-drop">
<a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
<span class="user-img"><img src="<?php echo !empty($users['user_photo']) ? base_url().$this->config->item('upload_url').'/'.$this->config->item('profile_upload_url').'/'.$users['user_photo'] : base_url().'assets/img/profiles/avator1.jpg';?>" alt="">
...
<hr class="m-0">
<a class="dropdown-item" href="<?php echo base_url();?>profile/view_profile/<?php echo $this->session->userdata('user_id');?>"> <i class="me-2" data-feather="user"></i> My Profile</a>
<!-- <a class="dropdown-item" href="generalsettings.html"><i class="me-2" data-feather="settings"></i>Settings</a> -->
<hr class="m-0">
<a class="dropdown-item logout pb-0" href="<?php echo base_url();?>login/logout"><img src="<?php echo base_url();?>assets/img/icons/log-out.svg" class="me-2" alt="img">Logout</a>
</div>
</div>
</li>
</ul>
